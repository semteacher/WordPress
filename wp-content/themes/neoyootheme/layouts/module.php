...
if ($style == '') {
	if ($module->position == 'header') $style = 'separator';
	if ($module->position == 'topblock') $style = 'glow';
	if ($module->position == 'top') $style = 'glow';
	...
	if ($module->position == 'bottom') $style = 'embedded';
	if ($module->position == 'bottomblock') $style = 'glow';
}
